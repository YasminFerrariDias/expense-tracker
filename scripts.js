...
amount.oninput = () => {
  ...
  // Transformar o valor em centavos - x: 150/100 = 1.5
...
function expenseAdd(newExpense) {
  try {
    ...
    // Limpa o formulario para adicionar novo item
    formClear()
...
function updateTotals() {
  try {
    ...
    for (let item = 0; item < items.length; item++) {
      ...
      // Remove os caracteres não númericos e substitui a , pelo .
      let value = itemAmount.textContent.replace(/[^\d,]/g, "").replace(",", ".")

      // converte o valor para a float
    ...
    // Adiciona o simbolo da moeda e no valor formatado
